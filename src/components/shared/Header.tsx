    ...
    <header className="relative w-full bg-gradient-to-b from-surface-container to-surface">
      ...
      <nav className="relative z-10 max-w-7xl mx-auto ">
        <div className="max-w-[1600px] mx-auto px-5 md:px-8 lg:px-12">
          ...
          {isMenuOpen && (
            <div className="lg:hidden py-4 border-t border-surface-tint/10 animate-in duration-200">
      ...
      {/* Hero Content Area */}
      <div className="relative max-w-7xl mx-auto mx-auto px-5 md:px-8 lg:px-12">
